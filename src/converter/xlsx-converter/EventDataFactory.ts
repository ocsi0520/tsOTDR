...
import type { AlignmentSetter } from "./utils/AlignmentSetter";
...
export class EventDataFactory {
  ...
  public getRows(representation: Representation): SheetData {
    ...
    const centeredRows = this.alignmentSetter.setAlignmentInSheet(
      precisionSetRows,
      {
        align: "center",
